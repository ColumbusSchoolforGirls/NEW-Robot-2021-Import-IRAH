...
public class DriveTrain extends SubsystemBase {
  ...
  //commented out for susan
  // sets variables to represent each wheel/motor/thing\
  //Commented out for susan
  ...
  private final CANSparkMax left_back = new CANSparkMax(RobotMap.left_back_motor, MotorType.kBrushless);
	...
	public static Spark left_front_S = new Spark(RobotMap.LEFT_FRONT_DRIVE_PORT);
	public static Spark right_front_S = new Spark(RobotMap.RIGHT_FRONT_DRIVE_PORT);
	public static Spark left_back_S = new Spark(RobotMap.LEFT_BACK_DRIVE_PORT);
	public static Spark right_back_S = new Spark(RobotMap.RIGHT_BACK_DRIVE_PORT);
  ...
  public void Wheelspeed(double leftspeed, double rightspeed){  
    //CHANGED TO _S FOR SUSAN, PUT BACK LATER
    right_front_S.set(-rightspeed);
    left_front_S.set(leftspeed);
    right_back_S.set(-rightspeed);
    left_back_S.set(leftspeed);
